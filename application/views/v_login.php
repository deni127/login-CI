                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12">
                                <div class="form-group wrap-input">
                                    <input type="text" name="usernameuser" class="form-control"  required="required" placeholder="Username">
                                    <span class="focus-input"></span>
                                </div>
                                <div class="form-group wrap-input">
                                    <div class="pwdMask">
                                        <input type="password" name="passworduser" class="form-control"  required="required" placeholder="Password">
                                        <span class="focus-input"></span>
